...
export function StudentLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-b from-[#f7f4ef] via-white to-[#eef4ff] text-foreground">
      <div className="relative">
        ...
        <div className="relative min-h-screen">
          ...
          <div className="flex">
            <StudentSidebar />
            <main className="flex-1 pb-24 pt-6 lg:pb-10">
